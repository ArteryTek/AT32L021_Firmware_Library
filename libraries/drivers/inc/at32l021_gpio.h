/**
  **************************************************************************
  * @file     at32l021_gpio.h
  * @brief    at32l021 gpio header file
  **************************************************************************
...
/**
  ...
  ----------------------------- --------------------------------------------------------------------------------------------------
  pa12         |             |  usart1_rts |  tmr1_etr   |             |  can_tx      |  i2c2_sda    |             |  eventout    |
  --------------------------------------------------------------------------------------------------------------------------------
...
/**
  ...
  --------------------------------------------------------------------------------------------------------------------------------
  pb9          |   ir_out    |   i2c1_sda  |  tmr17_ch1  |  eventout   |  can_tx      |             |  i2s1_mck   |   spi2_nss   |
               |             |             |             |             |              |             |             |   i2s2_ws    |
  --------------------------------------------------------------------------------------------------------------------------------
...
#ifndef __AT32L021_GPIO_H
#define __AT32L021_GPIO_H
