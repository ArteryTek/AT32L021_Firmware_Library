...
#ifndef __AT32L021_BOARD_H
#define __AT32L021_BOARD_H
...
/**
  ...
  * 1. at-start-l021 v1.x boards
  * if define AT_START_L021_V1, the header file support at-start-l021 v1.x board
  */

#if !defined (AT_START_L021_V1)
#error "please select first the board at-start device used in your application (in at32l021_board.h file)"
#endif
