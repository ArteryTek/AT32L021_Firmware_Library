...
/** @addtogroup 021_SPI_crc_transfer_polling SPI_crc_transfer_polling
  * @{
  */
...
int main(void)
{
  ...
  if((transfer_status1 == SUCCESS) && (transfer_status2 == SUCCESS) && (crc1_value == 0x8026) && (crc2_value == 0xCBF9))
  {
    at32_led_on(LED2);
  }
  else
