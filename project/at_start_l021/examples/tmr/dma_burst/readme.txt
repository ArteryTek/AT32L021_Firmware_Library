/**
  ...
  */
  ...
  registers beginning from tmr_pr register.
  on the dma update request, 0x0fff will be transferred into arr, 0x0000
  will be transferred into rcr, 0x0555 will be transferred into c1dt.
  ...
  the tmr1 period is 5.86 khz: tmr1 frequency = tmr1 counter clock/(pr + 1)
