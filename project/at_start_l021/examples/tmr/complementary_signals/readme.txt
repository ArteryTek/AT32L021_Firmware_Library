/**
  ...
  */
  ...
  the channel 1 duty cycle is set to 50% so channel 1c is set to 50%.
  the channel 2 duty cycle is set to 25% so channel 2c is set to 75%.
  the channel 3 duty cycle is set to 12.5% so channel 3c is set to 87.5%.
